...
class Plotter:
    def __init__(self, background, user_location, destination, path):
    ...
    def plot_graph(self):
        ...
        elevation = rasterio.open('elevation/out.tif')
        ...
        plt.text(1.1, 1.0, 'Elevation', transform=ax.transAxes, fontsize=4)
        ...
        plt.text(0, -0.025,
                 ...
                 verticalalignment='baseline', transform=ax.transAxes, fontsize='1')
        ...
        plt.title('Evacuation Route', size=8)
